...
export default function AttachmentPreviewModel({
    ...
    const preveiwableAttachments = useMemo(() => {
        return attachments.filter((attachment) => isPreviewable(attachment));
    }, [attachments]);
    const attachment = useMemo(() => {
        return preveiwableAttachments[currentIndex];
    ...
    const next = () => {
        if (currentIndex === preveiwableAttachments.length - 1) {
            return;
        }
        setCurrentIndex(currentIndex + 1);
    };
                           ...
                           transition-all"
                            >
                                ...
                                <div className="relative group h-full ">
                                    ...
                                    {currentIndex <
                                        preveiwableAttachments.length - 1 && (
                                        <div
                                            onClick={next}
                                            className="absolute opacity-100 text-gray-100
                                        cursor-pointer flex items-center justify-center
                                        w-16 h-16 right-4 top-1/2 translate-x-1/2
                                        rounded-full bg-black/50 z-30
                                        "
                                        >
